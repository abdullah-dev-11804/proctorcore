...
$string['enabled_help'] = 'Connects this Quiz to local_proctorcore and the Proctoring Server. Students complete the required checks, declarations, and identity workflow before Moodle creates the attempt.';
...
$string['requirerulesack'] = 'Require explicit exam-rules acknowledgement';
$string['ruleshtml'] = 'Exam rules';
$string['ruleshtml_help'] = 'Rules shown in the preflight form. Separate concise rules with | to display them as a responsive two-column list. The exact text hash, language, user, IP address, and acknowledgement time are recorded with the proctoring session.';
$string['error:rulesrequired'] = 'Enter the exam rules when acknowledgement is required.';
...
$string['requireidentity_help'] = 'Before Moodle creates the attempt, verify a live camera burst against the learner’s reusable encrypted face template. The configured mismatch policy controls the outcome.';
$string['identitymismatchmode'] = 'Identity mismatch action';
$string['identitymismatchmode_help'] = 'Override the company or platform action when a live face scores below the verification threshold.';
$string['identitymismatchmode_inherit'] = 'Use company/platform policy';
$string['identitymismatchmode_block'] = 'Block quiz entry';
$string['identitymismatchmode_review'] = 'Allow entry and require manual review';
$string['identitymismatchmode_fail'] = 'Allow entry and mark proctoring failed';
$string['identitythreshold'] = 'Identity threshold override';
$string['identitythreshold_help'] = 'Leave empty to inherit the company or platform threshold. Allowed range: 0.85 to 1.00.';
$string['error:identitythreshold'] = 'Enter an identity threshold between 0.85 and 1.00, or leave it empty.';
