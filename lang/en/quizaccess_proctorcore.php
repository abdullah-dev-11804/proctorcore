...
$string['ruleshtml_help'] = 'Rules shown in the preflight form. The exact text hash, language, user, IP address, and acknowledgement time are recorded with the proctoring session.';
